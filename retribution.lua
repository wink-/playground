...
--	unpack(Zylla.PayPal_IMG),
	...
	{type = 'checkspin',text = 'Light\'s Judgment - Units',key = 'LJ', spin = 4, step = 1, shiftStep = 2, max = 20, min = 1, check = false,	desc = Zylla.ClassColor..'World Spell usable on Argus.|r'},
